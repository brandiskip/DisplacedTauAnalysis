...
parser.add_argument(
    "--sample",
    default='Cosmic',
    choices=['Cosmic', 'Stau_100_100mm', 'Stau_300_100mm', 'Stau_500_100mm', 'NoBPTX'], 
...
# ADDED 100, 500, and NoBPTX to the samples dictionary
samples = {
    ...
    "NoBPTX" : f"samples.{outdir_p}fileset_NoBPTX",
}
...
# ADDED 100, 500, and NoBPTX to the parameters dictionary
pars_per_sample = {
    "Cosmic" : [50_000, 10], 
