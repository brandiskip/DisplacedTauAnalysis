...
class StauEfficiencyProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        def get_leading_jet(jets):
            sorted_jets = jets[ak.argsort(jets.disTauTag_score1, ascending=False)]
            leading_jet = sorted_jets[:, :1]
            return leading_jet
        ...
        if nGen > 0:
            ...
            matched_jet = gen_vis_taus.nearest(leading_jet, threshold=0.4)
...
if __name__ == "__main__":
    ...
    make_grid_plot("efficiency_simple_matching.json", "grid_plot_simple_matching_leading_score.pdf", "Efficiency: GenTau.nearest(Jet, dR<0.4)")
    print("Done!")